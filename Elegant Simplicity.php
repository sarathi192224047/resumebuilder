...
<body>
  ...
  <div class="container">
    <div class="resume-display" id="resume" contenteditable="true">
      ...
      <h2>Experience</h2>
      <h3>Resume Worded & Co.</h3>
      <p><strong>Financial Data Analyst, Business Development & Operations</strong></p>
      <p>Oct 2017 – Present | San Francisco, CA</p>
      <ul>
        <li>Managed cross-functional team of 10 in 3 locations...</li>
        <li>Launched Miami office and recruited new team...</li>
        <li>Designed training and peer-mentoring programs...</li>
      </ul>

      <h3>Instamake</h3>
      <p><strong>Associate Product Manager</strong></p>
      <p>Sept 2015 – Oct 2017 | San Francisco, CA</p>
      <ul>
        <li>Oversaw product portfolio of $2 million...</li>
        <li>Created and implemented new production schedules...</li>
        <li>Increased user base by 20% through targeted marketing...</li>
      </ul>

      <h2>Education</h2>
      <h3>University of California, San Francisco</h3>
      <p><strong>Bachelor of Science, Business Administration</strong></p>
      <p>2010 – 2014</p>
