...
$sql = "SELECT temp_name, category, upload FROM template WHERE category = 'Professional'";
    ...
    <li><label for="menuCheckbox"><a href="landing.php">Home</a></label></li>
      ...
      <li><label for="menuCheckbox"><a href="interview_schedule.php">Interview Scheduler</a></label></li>
        ...
        <div class="header">
            ...
            <p>Explore our collection of professional templates designed to elevate your resume.</p>
        </div>
