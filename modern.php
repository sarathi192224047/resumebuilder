...
// Fetch templates data for the 'Modern' category
$sql = "SELECT temp_name, category, upload FROM template WHERE category = 'Modern'";
...
<nav role="navigation">
  <div id="menuToggle">
    ...
    <div class="container">
        <!-- Header Section -->
        <div class="header">
            <h1>Modern Templates</h1>
            <p>Explore our collection of modern templates designed to impress and optimize your application process.</p>
        </div>
